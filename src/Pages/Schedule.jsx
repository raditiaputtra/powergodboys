...
const Schedule = () => {
  ...
  if (currentWeek === 1 || currentWeek === 3) {
    piketGroup = [
      ["Aghna", "Radit", "Adin", "farah", "Mutiara", "Rosma", "Elaa"],
      ["Fazri", "Revan", "Annisa", "Indi", "Nadia", "Salma", "Widya"],
      ["Mario", "Rifal", "Biandsy", "Julia", "Nazwa", "Septi"],
      ["Andra", "Rifki", "Dinda", "Karim", "Salwa", "Imas"],
      ["Pandu", "Topik", "Mayang", "Erin", "Pira", "Syinta cuy"],
    ];
